...
import { VxlanInterface, fetchVxlan } from "@/lib/api";
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-[36px] pt-[28px] pb-5 flex-shrink-0">
        ...
        {device && <p className="text-[13px] text-[var(--qz-fg-4)] mt-1">{"Virtual Extensible LAN (VXLAN) tunnel interfaces"}</p>}
      </div>
      ...
      <div className="flex-1 overflow-auto px-[36px] pb-[28px]">
        ...
        {status === "ready" && (
          <DataTable
            ...
            filters={filters}
            rowId={(r) => r.name}
            searchPlaceholder="Search VXLAN interfaces…"
